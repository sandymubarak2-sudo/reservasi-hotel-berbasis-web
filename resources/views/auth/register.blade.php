...
<head>
    ...
    <title>Daftar Akun - Sandy Hotel</title>
    ...
    <style>
        ...
        body {
            ...
            /* Latar Belakang Gambar Mewah (Beda sudut dari halaman login agar bervariasi) */
...
<body>
    ...
    <div class="login-card">
        <div class="login-header text-center mb-4">
            ...
            <h2>BERGABUNG</h2>
            <p class="text-muted small">Buat akun untuk menikmati layanan kami</p>
        </div>
        ...
        <form action="{{ url('/register') }}" method="POST">
            ...
            <div class="mb-3">
                <label class="form-label fw-semibold small text-muted text-uppercase">Nama Lengkap</label>
                <div class="input-group">
                    <span class="input-group-text"><i class="fas fa-user"></i></span>
                    <input type="text" name="name" class="form-control" placeholder="Masukkan nama lengkap Anda" required autofocus>
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="form-text small opacity-75">Gunakan kombinasi yang aman untuk privasi Anda.</div>
            </div>

            <div class="d-grid mb-4">
                <button type="submit" class="btn btn-register text-uppercase">Daftar Sekarang</button>
            </div>
            
            <div class="text-center mt-3 border-top pt-3">
                <span class="text-muted small">Sudah memiliki akun?</span> 
                <a href="{{ url('/login') }}" class="login-link small">Masuk di sini</a>
            </div>
